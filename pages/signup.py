...
if submit:
    ...
    try:
        ...
        st.info("Please check your email inbox. If no email has been sent, please try again later.")
        print(e)
st.divider()
st.markdown("<p class='center_title caption_styling'>All information you provided here will not be shared. I promise.</p>", unsafe_allow_html=True)